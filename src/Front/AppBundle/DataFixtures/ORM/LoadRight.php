...
class LoadRight extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $roles = array(
            ...
            array(
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_ACHAT"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_EBUISINESS"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_FINANCES"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_GISS"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_JURIDIQUE"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_LOGISTIQUE"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_MARKETING"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_ORGANISATION"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_PERFCO"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_QUALITE"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_RH"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_RESEAU"),
                array("ROLE_DOMAIN_NEWS_DOCUMENT", "ROLE_DOMAIN_GRANDSCOMPTES"),
