...
{
    public function loginAction(Request $request, $isLongTemplate=true)
    {
        ...
        if (class_exists('\Symfony\Component\Security\Core\Security')) {
            ...
            // BC for SF < 2.6
            throw new \RuntimeException('An error occured, you have to check the Security Controller');
        }
