...
class MenuGetter extends MenuGetterBase
{
    public function getMenus($currentRoute) {
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_USER_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_user_manager_homepage"),
                "name" => "Utilisateurs",
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_GROUP_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_group_manager_homepage"),
                "name" => "Groupes",
                "active" => in_array($currentRoute,
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_APPLICATION_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_application_manager_homepage"),
                "name" => "Applications",
                "active" => in_array($currentRoute,
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_AGENCY_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_agency_manager_homepage"),
                "name" => "Agences",
                "active" => in_array($currentRoute,
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_REGION_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_region_manager_homepage"),
                "name" => "Régions",
                "active" => in_array($currentRoute,
        ...
        if ($this->authorization_checker->isGranted('ROLE_ADMIN_ZONE_VIEW')) {
            $menu = array("route" => $this->router->generate("admin_zone_manager_homepage"),
                "name" => "Zones",
                "active" => in_array($currentRoute,
